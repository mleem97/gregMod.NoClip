# AGENTS.md — Hinweise für KI-Agenten (gregMod.NoClip)

Repo: [https://github.com/mleem97/gregMod.NoClip](https://github.com/mleem97/gregMod.NoClip) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
